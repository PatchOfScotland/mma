...
-- ==
-- "N:16 " compiled random input { 16i64 [256][256]f32 }
-- "N:32 " compiled random input { 32i64 [512][512]f32 }
-- "N:64 " compiled random input { 64i64 [1024][1024]f32 }
-- "N:128 " compiled random input { 128i64 [2048][2048]f32 }
...
def main [m] (bb: i64) (mat: [m][m]f32): [m][m]f32 =
    let b = bb
