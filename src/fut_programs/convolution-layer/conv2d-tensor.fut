...
def add_padding [l][n][m] (imgs : [l][n][m]f16) (padding : i64) =
  ...
  in map (\ img_i -> tabulate_2d n_pad m_pad (\ i j ->
      if (i < padding || i >= (n+padding) || j < padding || j >= (m+padding)) 
      then 
        0 
      else 
        img_i[i-padding,j-padding])) 
    imgs
...
-- nobench input @data/c_1024-128-128f16_256-1024-3-3f16_256f16_1i64.in output @data/c_1024-128-128f16_256-1024-3-3f16_256f16_1i64_tensor.out
